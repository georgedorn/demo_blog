...
DATABASES = {
    'default': {
        ...
        'USER': 'tblog',                      # Not used with sqlite3.
        'PASSWORD': 'tblog_pass',                  # Not used with sqlite3.
...
SECRET_KEY = 'b9thfw4l$)!5rof%mh%+ya@n%8pqn4x-ly69q%k^-ol8c6n5kn'
...
JOHNNY_MIDDLEWARE_KEY_PREFIX='jc_tblog'
...
#see http://stackoverflow.com/questions/806835/django-redirect-to-previous-page-after-login
